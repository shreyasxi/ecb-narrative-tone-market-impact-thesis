...
## Abstract
This thesis studies whether, and through which communication channels, the European Central Bank’s (ECB) **narrative tone** affects **daily euro-area financial markets**. Tone is measured with ECB-adapted hawk–dove dictionaries at the sentence level and standardized within channel. We compare press releases, press-conference Q&A, monetary policy accounts, and Executive Board speeches. Using stacked daily panels with asset and time fixed effects and two-way clustered standard errors, we test for **cross-channel heterogeneity** and **state dependence** via the ECB Composite Indicator of Systemic Stress (CISS).
...
*(Replace with your final bullets as you lock results.)*
